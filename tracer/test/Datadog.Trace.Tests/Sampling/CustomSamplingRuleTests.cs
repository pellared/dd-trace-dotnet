...
namespace Datadog.Trace.Tests.Sampling
{
    ...
    public class CustomSamplingRuleTests
    {
        ...
        private static readonly Span CartCheckoutSpan = new Span(new SpanContext(Id++, Id++, serviceName: "shopping-cart-service"), DateTimeOffset.Now) { OperationName = "checkout" };
        private static readonly Span AddToCartSpan = new Span(new SpanContext(Id++, Id++, serviceName: "shopping-cart-service"), DateTimeOffset.Now) { OperationName = "cart-add" };
        private static readonly Span ShippingAuthSpan = new Span(new SpanContext(Id++, Id++, serviceName: "shipping-auth-service"), DateTimeOffset.Now) { OperationName = "authorize" };
        private static readonly Span ShippingRevertSpan = new Span(new SpanContext(Id++, Id++, serviceName: "shipping-auth-service"), DateTimeOffset.Now) { OperationName = "authorize-revert" };
        private static readonly Span RequestShippingSpan = new Span(new SpanContext(Id++, Id++, serviceName: "request-shipping"), DateTimeOffset.Now) { OperationName = "submit" };
