    ...
    internal static class NLogCommon<TTarget>
    {
        ...
        static NLogCommon()
        {
            ...
            if (_targetType is not null)
            {
                ...
                var sink = new DirectSubmissionNLogTarget(
                ...
                _targetProxy = CreateNLogTargetProxy(sink);
                return;
            }
            ...
            var legacySink = new DirectSubmissionNLogLegacyTarget(
                DirectLogSubmission.Instance.Sink,
                DirectLogSubmission.Instance.Settings.MinimumLevel,
                DirectLogSubmission.Instance.Formatter);

            _targetProxy = CreateNLogTargetProxy(legacySink);
        ...
        internal static Func<object> CreateLoggingRuleActivator(Assembly nlogAssembly)
        {
            ...
            var ctor = loggingRuleType.GetConstructor(System.Type.EmptyTypes);
