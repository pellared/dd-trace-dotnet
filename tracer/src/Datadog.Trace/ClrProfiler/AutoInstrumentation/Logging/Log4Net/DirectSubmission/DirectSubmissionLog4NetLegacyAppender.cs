...
namespace Datadog.Trace.ClrProfiler.AutoInstrumentation.Logging.Log4Net.DirectSubmission
{
    ...
    public class DirectSubmissionLog4NetLegacyAppender
    {
        ...
        private static DirectSubmissionLog4NetLegacyAppender _instance;
        ...
        {
            get { return LazyInitializer.EnsureInitialized<DirectSubmissionLog4NetLegacyAppender>(ref _instance, CreateStaticInstance); }
        }
        ...
        public void DoAppend(LoggingEventLegacyDuck logEvent)
        {
            ...
            _sink.EnqueueLog(new Log4NetDatadogLogEvent(logEvent, logEvent.TimeStamp.ToUniversalTime()));
        }
